  ...
  charts: {
    ...
    rows: [
      ...
      },
      {
        ...
        body: 'A swim or splash. It instantly strips part of your protection, and that’s the sharp drop.',
      },
      {
    ...
    rows: [
      {
        icon: 'water-outline',
        title: 'What it changes',
        body: 'How much protection each swim or splash strips away. A 40-min rating loses more per dip than an 80-min one, so the drops on the line get deeper.',
      },
    ],
  },
  timing: {
    ...
    rows: [
      {
        ...
        title: 'What it changes',
        body: 'More movement means more sweat and friction, which strips sunscreen faster, and the whole line gets steeper. This replaces the recorded activity for the entire session.',
      },
    ],
  },
};
